...
-- SECTION A: TABLE CREATION AND BASIC CONSTRAINSTS
...
ALTER TABLE Books ADD CONSTRAINT chk_price CHECK (price <= 10000);
...
ALTER TABLE Orders ADD CONSTRAINT fk_delivery 
...
-- SECTION D: DROPPING AND REMNAMING
